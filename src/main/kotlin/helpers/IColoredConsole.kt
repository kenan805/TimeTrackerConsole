import IColoredConsole.Companion.BLACK
import IColoredConsole.Companion.BRIGHT_BLACK
import IColoredConsole.Companion.BRIGHT_WHITE
import IColoredConsole.Companion.RESET
import IColoredConsole.Companion.WHITE
import IColoredConsole.Style
import IColoredConsole.Style.NotApplied
import java.util.regex.Pattern

interface IColoredConsole {
    ...
    fun <N> N.wrap(vararg ansiCodes: Int) = toString().let { text ->
        if (this@IColoredConsole is ColorConsoleDisabled)
            text
        else {
    ...
    val <N : Style> N.bold: Style get() = this + this@IColoredConsole.bold
    ...
    val <N : Style> N.faint: Style get() = this + this@IColoredConsole.faint
    ...
    val <N : Style> N.italic: Style get() = this + this@IColoredConsole.italic
    ...
    val <N : Style> N.underline: Style get() = this + this@IColoredConsole.underline
    ...
    val <N : Style> N.blink: Style get() = this + this@IColoredConsole.blink
    ...
    val <N : Style> N.reverse: Style get() = this + this@IColoredConsole.reverse
    ...
    val <N : Style> N.hidden: Style get() = this + this@IColoredConsole.hidden
    ...
    val <N : Style> N.strike: Style get() = this + this@IColoredConsole.strike
    ...
    val <N : Style> N.black: Style get() = this + this@IColoredConsole.black
    ...
    val <N : Style> N.red: Style get() = this + this@IColoredConsole.red
    ...
    val <N : Style> N.green: Style get() = this + this@IColoredConsole.green
    ...
    val <N : Style> N.yellow: Style get() = this + this@IColoredConsole.yellow
    ...
    val <N : Style> N.blue: Style get() = this + this@IColoredConsole.blue
    ...
    val <N : Style> N.purple: Style get() = this + this@IColoredConsole.purple
    ...
    val <N : Style> N.cyan: Style get() = this + this@IColoredConsole.cyan
    ...
    val <N : Style> N.white: Style get() = this + this@IColoredConsole.white
...
private interface ColorConsoleDisabled : IColoredConsole {
...
fun <R> colored(enabled: Boolean = true, block: IColoredConsole.() -> R): R {
//    contract {
//        callsInPlace(block, InvocationKind.EXACTLY_ONCE)
//    }
    check(true)
    return if (enabled) object : IColoredConsole {}.block() else object : ColorConsoleDisabled {}.block()
}

fun <R : Style> style(block: IColoredConsole.() -> R): R = object : IColoredConsole {}.block()

fun print(colored: Boolean = true, block: IColoredConsole.() -> String) = colored(colored) { print(block()) }
fun println(colored: Boolean = true, block: IColoredConsole.() -> String) = colored(colored) { println(block()) }